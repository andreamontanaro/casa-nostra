import { House, Zap, ShoppingBasket, UtensilsCrossed, Tv, Sofa, Fuel, Plane, Package, type LucideIcon } from 'lucide-react'
import { CATEGORY_VISUAL } from '@/lib/fmt'
import { cn } from '@/lib/utils'
const ICONS: Record<string, LucideIcon> = { affitto: House, bolletta: Zap, spesa_alimentare: ShoppingBasket, ristorazione: UtensilsCrossed, abbonamento: Tv, casa_arredo: Sofa, trasporti: Fuel, viaggi: Plane, altro: Package }
